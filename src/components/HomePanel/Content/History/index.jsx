...
import { Button, Timeline, ClockCircleOutlined, Popover, Table, List } from 'antd';
...
@inject('ChooseStore', 'HistoryStore', 'UserLabInfoStore')
@observer
  ...
  render() {
    ...
    for (let key in mapObj) {
      ...
      changeArr.map((item, index) =>
        // item["key"]=index
        newChangeArr.push(Object.assign({}, item, { key: index }))
      );
                              ...
                              <>
                                ...
                                <Popover
                                  ...
                                  content={(
                                    <List
                                      size="small"
                                      header={<div style={{ fontWeght: 700 }}>其他物品(同个excel文件一起导入):</div>}
                                      footer={null}
                                      bordered
